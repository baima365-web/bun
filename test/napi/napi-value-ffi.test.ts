...
// NOTE: napi_env / napi_value are cc()-only under the engine-native FFI (dlopen/linkSymbols/
// CFunction/JSCallback reject them by design), so there is no dlopen-based napi integration
// to test; the cc()-based integration below is the supported path.
